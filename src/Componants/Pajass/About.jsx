const About = () => {
  return (
    <div className="">
      <h1 className="text-5xl font-bold">Dream Home</h1>
      <div className="mt-5 ">
        <p className="text-xl bg-cyan-50 p-10 border-2 rounded-3xl">
          Luxury homes represent the pinnacle of opulence, elegance, and
          comfort, offering a lifestyle defined by exclusivity and
          sophistication. From sprawling mansions to sleek penthouses, each
          luxury home is a testament to architectural mastery, impeccable
          design, and lavish amenities. At the heart of every luxury home is a
          commitment to creating an unparalleled living experience. 
         <br /> These
          residences often feature expansive living spaces adorned with high-end
          finishes, custom millwork, and state-of-the-art technology. From grand
          foyers with soaring ceilings to gourmet kitchens equipped with
          ...
          these residences offer a wealth of leisure and entertainment options.
          Outdoor amenities such as infinity pools, tennis courts, and outdoor
          kitchens further enhance the living experience, transforming the home
          into a private oasis for enjoyment and relaxation. Location plays a
          ...
          door, a luxury home envelops its occupants in a cocoon of luxury,
          offering an experience that is truly extraordinary.
        </p>
      </div>
    </div>
  );
